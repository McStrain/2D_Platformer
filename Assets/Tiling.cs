...
public class Tiling : MonoBehaviour {
    ...
    void MakeNewBuddy(int rightOfLeft)
    {
        ...
        Vector3 newPosition = new Vector3(myTransform.position.x + spriteWidth * rightOfLeft, myTransform.position.y, myTransform.position.z);
        // Creating a new buddy and storing him in a variable
